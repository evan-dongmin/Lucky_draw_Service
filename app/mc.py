...
STATIC_TEMPLATES: dict[str, list[str]] = {
    ...
    "gambling_open": [
        "베팅 창이 열렸습니다! 사이버머니를 어디에 거시겠습니까?",
        "{round}라운드 베팅을 받습니다. 판돈이 쌓일수록 배당은 낮아집니다!",
        "지금부터 베팅 가능합니다. 남들과 다른 선택이 더 큰 배당을 노릴 수 있어요!",
        "베팅 창이 곧 닫힙니다. 서둘러 주세요!",
        "판돈이 몰리는 쪽은 배당이 낮아지고 있습니다. 역배를 노려보시겠습니까?",
    ],
    "gambling_result": [
        "베팅 정산 결과가 나왔습니다! 판돈을 맞힌 분들, 축하합니다!",
        "이번 라운드 판돈이 승자들에게 분배됩니다!",
        "누군가는 웃고, 누군가는 다음 라운드를 노려야겠습니다!",
        "베팅 결과가 반영됐습니다. 사이버머니 잔액을 확인해보세요!",
    ],
    "gambling_champion": [
        "오늘의 사이버머니 갬블링 챔피언이 결정됐습니다!",
        "가장 많은 사이버머니를 모은 참가자, 축하합니다!",
        "베팅의 승자가 가려졌습니다! 대단한 배짱이었습니다!",
    ],
    "elimination": [
    ...
    "prediction_open": [
        ...
        "다음 라운드 예측 시간입니다. 확신도를 어디에 거시겠습니까?",
