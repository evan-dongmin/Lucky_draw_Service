"""Director Agent: 5분 시간 예산의 총괄 관리자.

기획안 §4의 런북(10+10+45+30+45+30+70+30+30=300초)을 총 시간에 맞춰
비례 스케일링한다. 예측 게임이 꺼져 있으면 선택창 구간을 짧은 발표로
...
# 되는 것을 막기 위한 최소 총 시간. 실제 서비스는 항상 300초 근방을 쓰므로
